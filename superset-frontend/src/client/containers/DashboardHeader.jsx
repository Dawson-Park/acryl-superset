...
import DashboardHeader from 'src/client/components/Header';
import isDashboardLoading from 'src/client/util/isDashboardLoading';
...
import { DASHBOARD_HEADER_ID } from 'src/client/util/constants';
