...
import { hydrateDashboard } from 'src/client/actions/hydrate';
import { setDatasources } from 'src/client/actions/datasources';
...
import { getFilterSets } from 'src/client/actions/nativeFilters';
import { setDatasetsStatus } from 'src/client/actions/dashboardState';
import {
  getFilterValue,
  getPermalinkValue,
} from 'src/client/components/nativeFilters/FilterBar/keyValue';
import DashboardContainer from 'src/client/containers/Dashboard';
...
const DashboardBuilder = React.lazy(
  () =>
    import(
      ...
      /* webpackPreload: true */
      'src/client/components/DashboardBuilder/DashboardBuilder'
    ),
);
