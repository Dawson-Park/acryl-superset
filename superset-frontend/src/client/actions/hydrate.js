...
import { initSliceEntities } from 'src/client/reducers/sliceEntities';
import { getInitialState as getInitialNativeFilterState } from 'src/client/reducers/nativeFilters';
import { applyDefaultFormData } from 'src/explore/store';
import { buildActiveFilters } from 'src/client/util/activeDashboardFilters';
import { findPermission } from 'src/utils/findPermission';
import {
  canUserEditDashboard,
  canUserSaveAsDashboard,
} from 'src/client/util/permissionUtils';
import {
  getCrossFiltersConfiguration,
  isCrossFiltersEnabled,
} from 'src/client/util/crossFilters';
import {
  DASHBOARD_FILTER_SCOPE_GLOBAL,
  dashboardFilter,
} from 'src/client/reducers/dashboardFilters';
import {
  DASHBOARD_HEADER_ID,
  GRID_DEFAULT_CHART_WIDTH,
  GRID_COLUMN_COUNT,
  DASHBOARD_ROOT_ID,
} from 'src/client/util/constants';
import {
  DASHBOARD_HEADER_TYPE,
  CHART_TYPE,
  ROW_TYPE,
} from 'src/client/util/componentTypes';
import findFirstParentContainerId from 'src/client/util/findFirstParentContainer';
import getEmptyLayout from 'src/client/util/getEmptyLayout';
import getFilterConfigsFromFormdata from 'src/client/util/getFilterConfigsFromFormdata';
import getLocationHash from 'src/client/util/getLocationHash';
import newComponentFactory from 'src/client/util/newComponentFactory';
