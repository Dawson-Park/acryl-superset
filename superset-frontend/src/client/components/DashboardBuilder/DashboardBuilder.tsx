...
import getDirectPathToTabIndex from 'src/client/util/getDirectPathToTabIndex';
...
import {
  ...
  setEditMode,
} from 'src/client/actions/dashboardState';
import {
  deleteTopLevelTabs,
  handleComponentDrop,
} from 'src/client/actions/dashboardLayout';
import {
  DASHBOARD_GRID_ID,
...
import FilterBar from 'src/client/components/nativeFilters/FilterBar';
...
const StyledDashboardContent = styled.div<{
  ...
  ${({ theme, editMode, marginLeft }) => css`
    ...
    .dashboard-component-chart-holder {
      ...
      box-shadow: 2px 2px 4px 0 rgba(139, 149, 187, 0.08) !important;
