...
import { nativeFiltersInfo } from 'src/client/fixtures/mockNativeFilters';
...
import getLeafComponentIdFromPath from 'src/client/util/getLeafComponentIdFromPath';
import emptyDashboardLayout from 'src/client/fixtures/emptyDashboardLayout';
