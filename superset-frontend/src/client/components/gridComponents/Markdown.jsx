...
import MarkdownModeDropdown from 'src/client/components/menu/MarkdownModeDropdown';
...
import { ROW_TYPE, COLUMN_TYPE } from 'src/client/util/componentTypes';
import {
...
const MarkdownStyles = styled.div`
  ${({ theme }) => css`
    &.dashboard-markdown {
      ...
      box-shadow: 0 2px 4px 0 rgba(139, 149, 187, 0.08) !important;
