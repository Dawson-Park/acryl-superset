...
import { LayoutItem, RootState } from 'src/client/types';
import AnchorLink from 'src/client/components/AnchorLink';
import Chart from 'src/client/containers/Chart';
...
import getChartAndLabelComponentIdFromPath from 'src/client/util/getChartAndLabelComponentIdFromPath';
import useFilterFocusHighlightStyles from 'src/client/util/useFilterFocusHighlightStyles';
import { COLUMN_TYPE, ROW_TYPE } from 'src/client/util/componentTypes';
import {
  GRID_BASE_UNIT,
  GRID_GUTTER_SIZE,
