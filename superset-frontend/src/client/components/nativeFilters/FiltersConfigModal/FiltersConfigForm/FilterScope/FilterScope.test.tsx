...
import { NativeFiltersForm } from 'src/client/components/nativeFilters/FiltersConfigModal/types';
import FiltersConfigForm, {
  FilterPanels,
} from 'src/client/components/nativeFilters/FiltersConfigModal/FiltersConfigForm/FiltersConfigForm';
