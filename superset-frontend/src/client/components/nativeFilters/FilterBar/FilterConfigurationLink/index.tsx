...
import { setFilterConfiguration } from 'src/client/actions/nativeFilters';
import Button from 'src/components/Button';
import { FilterConfiguration, styled } from '@superset-ui/core';
import FiltersConfigModal from 'src/client/components/nativeFilters/FiltersConfigModal/FiltersConfigModal';
