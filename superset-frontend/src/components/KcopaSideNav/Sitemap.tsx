  ...
  <div className="menu monitoring">
    ...
    <div className="submu">
      ...
      <div className="contents">
        ...
        <ul>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/dashboard/index.do">
              대시보드
            </A>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/itemAnalyze/index.do">
              사이트 프로파일링
            </A>
          </li>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/profiling/index.do">
              침해그룹 추적
            </A>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/blockAccess/index.do">
              접속차단
            </A>
          </li>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/blockSearch/index.do">
              검색차단
            </A>
          </li>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/searchCollectionList/index.do">
              검색·수집
            </A>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/icopw/index.do">
              ICOP-W
            </A>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/statistics/index.do">
              수집통계 및 리포트
            </A>
          </li>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/libraryList/index.do">
              수집 목록
            </A>
          </li>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/libraryEvidencebag/index.do">
              채증 목록
            </A>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/mgmtKeyContents/index.do">
              중점보호저작물 관리
            </A>
          </li>
          <li>
            <A to="http://icopsmt.kcopa.or.kr:8080/acct/mgmtField/index.do">
              수집 필드 관리
            </A>
          </li>
          <li>
    ...
    <div className="submu">
      ...
      <div className="contents">
        ...
        <ul>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=8">
              신고 배정
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=9">
              민원 신고 관리
            </A>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=10">
              보호요청 신청 접수
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=11">
              보호요청 저작물 목록
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=12">
              조치 목록
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=13">
              OSP 안내 발송
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=14">
              OSP 이행 확인
            </A>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=15">
              불법복제물 신고 접수
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=16">
              검색제한 요청관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=17">
              광고게재중단요청 신고 접수
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=18">
              광고게재중단요청 협조공문관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=36">
              신규 차단 사이트 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=19">
              접속차단 요청관리
            </A>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=21">
              계정정지
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=22">
              상습유포자 관리
            </A>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=23">
              불법복제물 심의요청 현황
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=24">
              시정권고서 생성
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=25">
              시정권고서 발송
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=49">
              시정권고서 발송내역
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=26">
              권고 이행
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=27">
              권고대장
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=28">
              이의신청
            </A>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=29">
              재택근로자 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=40">
              휴일 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=41">
              연차 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=42">
              휴가신청 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=43">
              평가 그룹(회차) 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=44">
              평가 현황
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=45">
              근태 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=46">
              복무 확인 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=30">
              모니터링 배정 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=32">
              일일보고 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=34">
              공지사항 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=35">
              재직·경력 증명서 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=38">
              모니터링 계정 관리
            </A>
          </li>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=39">
              근무조 관리
            </A>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=48">
              자료 관리
            </A>
          </li>
        </ul>
...
const Review = () => (
  <div className="menu review">
    ...
    <div className="contents">
      ...
      <ul>
        <li>
          <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=5">
            불법복제물/계정정지
          </A>
        </li>
        <li>
          <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=6">
            검색결과 제한
          </A>
        </li>
        <li>
          <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=7">
            정보제공 청구
          </A>
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=11">기타 안건</A>
        </li>
        <li>
          <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=12">
            심의이슈 관리
  ...
  <div className="menu portal">
    ...
    <div className="contents">
      ...
      <ul>
        ...
        <li>
          <A to="http://175.114.243.101:50003/p/cims">공동편집</A>
        </li>
        <li>
          <A to="https://icopsres.kcopa.or.kr/login.do#MENU_ID=24">한글 편집</A>
        </li>
      </ul>
      <h4>테스트1</h4>
      <ul>
