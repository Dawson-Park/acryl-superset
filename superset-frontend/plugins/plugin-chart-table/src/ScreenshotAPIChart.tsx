...
import DataScreenshot, {
  DataTableProps,
  SearchInputProps,
  SelectPageSizeRendererProps,
  SizeOption,
} from './DataScreenshotAPI';

import Styles from './Styles';
import { formatColumnValue } from './utils/formatValue';
import { PAGE_SIZE_OPTIONS } from './consts';
import { updateExternalFormData } from './DataScreenshot/utils/externalAPIs';
import getScrollBarSize from './DataScreenshot/utils/getScrollBarSize';
...
export default function TableChart<D extends DataRecord = DataRecord>(
  ...
  // React.useEffect(() => {
  //   console.log('props props props props props props props props props props props props props props props props')
  //   console.log(props)
  // }, [props])
